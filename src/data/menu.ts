...
export const INGREDIENTS: Ingredient[] = [
  ...
  { id: "pasta", name: "Pasta", group: "base", price: 0, calories: 220, protein: 8, tags: ["veg"] },
  { id: "mixed-greens", name: "Mixed greens", group: "base", price: 0, calories: 15, protein: 1, tags: ["veg", "gf"] },
  ...
  { id: "grilled-chicken", name: "Grilled chicken", group: "protein", price: 3.5, calories: 185, protein: 35, tags: ["gf"] },
  { id: "steak", name: "Steak", group: "protein", price: 4.5, calories: 240, protein: 35, tags: ["gf"] },
  { id: "salmon", name: "Salmon", group: "protein", price: 5.5, calories: 235, protein: 25, tags: ["gf"] },
  { id: "ground-turkey", name: "Ground turkey", group: "protein", price: 3, calories: 240, protein: 31, tags: ["gf"] },
  { id: "tofu", name: "Tofu", group: "protein", price: 2.5, calories: 163, protein: 20, tags: ["veg", "gf"] },
  { id: "eggs", name: "Eggs", group: "protein", price: 2, calories: 143, protein: 13, tags: ["veg", "gf"] },
  { id: "no-protein", name: "No protein", group: "protein", price: 0, calories: 0, protein: 0, tags: ["veg", "gf"] },
  { id: "broccoli", name: "Broccoli", group: "veggies", price: 0, calories: 27, protein: 2, tags: ["veg", "gf"] },
  { id: "bell-peppers", name: "Bell peppers", group: "veggies", price: 0, calories: 20, protein: 1, tags: ["veg", "gf"] },
  { id: "corn", name: "Corn", group: "veggies", price: 0, calories: 70, protein: 3, tags: ["veg", "gf"] },
  { id: "black-beans", name: "Black beans", group: "veggies", price: 0, calories: 110, protein: 7, tags: ["veg", "gf"] },
  { id: "spinach", name: "Spinach", group: "veggies", price: 0, calories: 21, protein: 3, tags: ["veg", "gf"] },
  { id: "cucumber", name: "Cucumber", group: "veggies", price: 0, calories: 8, protein: 0, tags: ["veg", "gf"] },
  { id: "cherry-tomatoes", name: "Cherry tomatoes", group: "veggies", price: 0, calories: 13, protein: 1, tags: ["veg", "gf"] },
  { id: "red-onion", name: "Red onion", group: "veggies", price: 0, calories: 32, protein: 1, tags: ["veg", "gf"] },
  { id: "pico", name: "Pico", group: "toppings", price: 0, calories: 5, protein: 0, tags: ["veg", "gf"] },
  { id: "corn-salsa", name: "Corn salsa", group: "toppings", price: 0, calories: 40, protein: 2, tags: ["veg", "gf"] },
  { id: "pickled-jalapenos", name: "Pickled jalapeños", group: "toppings", price: 0, calories: 3, protein: 0, tags: ["veg", "gf", "spicy"] },
  { id: "cheese", name: "Cheese", group: "toppings", price: 0.5, calories: 110, protein: 7, tags: ["veg", "gf"] },
  { id: "sour-cream", name: "Sour cream", group: "toppings", price: 0.5, calories: 60, protein: 1, tags: ["veg", "gf"] },
  { id: "feta", name: "Feta", group: "toppings", price: 0.75, calories: 75, protein: 4, tags: ["veg", "gf"] },
  { id: "guac", name: "Guac", group: "toppings", price: 1.75, calories: 90, protein: 1, tags: ["veg", "gf"] },
  { id: "chipotle-crema", name: "Chipotle crema", group: "sauce", price: 0, calories: 80, protein: 1, tags: ["veg", "gf", "spicy"] },
  { id: "buffalo", name: "Buffalo", group: "sauce", price: 0, calories: 30, protein: 0, tags: ["veg", "gf", "spicy"] },
  { id: "teriyaki", name: "Teriyaki", group: "sauce", price: 0, calories: 32, protein: 2, tags: ["veg"] },
  { id: "ranch", name: "Ranch", group: "sauce", price: 0, calories: 130, protein: 1, tags: ["veg", "gf"] },
  { id: "hot-honey", name: "Hot honey", group: "sauce", price: 0, calories: 128, protein: 0, tags: ["veg", "gf", "spicy"] },
  { id: "none", name: "None", group: "sauce", price: 0, calories: 0, protein: 0, tags: ["veg", "gf"] },
  { id: "pesto", name: "Pesto", group: "sauce", price: 0.5, calories: 160, protein: 3, tags: ["veg", "gf"] },
  { id: "double-protein", name: "Double protein", group: "extras", price: 3, calories: 185, protein: 35, tags: ["gf"] },
  { id: "extra-base", name: "Extra base", group: "extras", price: 1, calories: 205, protein: 4, tags: ["veg"] },
  { id: "protein-shake", name: "Protein shake", group: "extras", price: 3.5, calories: 270, protein: 34, tags: ["veg", "gf"] },
  { id: "cookie", name: "Cookie", group: "extras", price: 1.5, calories: 380, protein: 4, tags: ["veg"] },
];
